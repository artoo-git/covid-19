...
###                                 Bootstrap values of plateau for UK
...
hist(bootL$coefboot[,1], xlab = paste("Prediction of tot detected cases at plateau -", sysdate), breaks = 200, main = paste(country,": Bootstrap extrapolation of total count at plateau (", sysdate, ")"))
